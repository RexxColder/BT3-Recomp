    ...
    void reportLoop()
    {
        ...
        for (;;)
        {
            ...
            {   // [waitprof] blocked time per wait site over the window, ms/s
                static const char *const kSite[WP_COUNT] = { "framegate", "kickq_frames", "kickq_full", "kick_drain", "sched_yield", "sched_slot", "handoff", "sema", "sync_other", "sleep", "worker_idle", "fence_syncpath", "fence_storeimg", "barrier_post", "barrier_upload", "decpool" };
