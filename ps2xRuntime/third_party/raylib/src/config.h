...
//#define SUPPORT_PARTIALBUSY_WAIT_LOOP  1   // [ps2x] the 5%-of-slack busy loop burns ~0.8 ms/frame of a core (measured [frameprof]); sleep the whole wait instead
...
#define MAX_GAMEPADS                   16       // Maximum number of gamepads supported
