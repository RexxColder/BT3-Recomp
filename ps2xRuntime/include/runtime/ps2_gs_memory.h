...
namespace GSMem
{
	...
	// Byte offset of pixel (x,y) for the CT32/CT24 page layout (both share the C32
	// page table). Lets the rasterizer compute the framebuffer address ONCE and do a
	// direct read-modify-write instead of two swizzled std::function lookups per pixel.
